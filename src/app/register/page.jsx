          ...
          <div className="bg-white border border-[#E8E6E3] rounded-xl p-6 md:p-8 shadow-md">
            ...
            <div className="mt-4">
              <label className="flex items-center space-x-2 text-sm text-[#0A0A0A] cursor-pointer">
                ...
                />
                <span>
                  By checking, you are allowing allowing to receive{' '}
                  <b>transactional/informational SMS</b> communication regarding
                  account notifications, customer care, etc from{' '}
                  <b>CatchMyCash</b>. Messages frequency may vary. data rates
                  may apply, <b>reply STOP to opt-out</b>.
                </span>
              </label>
            </div>
            <div className="mt-4">
              <label className="flex items-center space-x-2 text-sm text-[#0A0A0A] cursor-pointer">
                ...
                <span>
                  I accept the{' '}
                  <a href="/privacy" className="text-[#E1261C] underline">
                    privacy policy
                  </a>{' '}
                  and{' '}
                  <a href="/terms" className="text-[#E1261C] underline">
                    terms of service
                  </a>{' '}
                  of CatchMyCash.
                </span>
