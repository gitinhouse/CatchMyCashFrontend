...
import { Search, Globe, Shield, Zap, Eye, Lock, ArrowRight, AlertTriangle, MapPin, Home } from 'lucide-react';
...
const PropertySearch = ({ onNext }) => {
  ...
  useEffect(() => {
    if (validationError && (firstName.trim() || lastName.trim() || address.trim() || city.trim() || zipCode.trim())) {
      // setValidationError('');
    }
  ...
  const handleSearch = () => {
    ...
    if (missingFields.length > 0) {
      if (missingFields.length === 1) {
        ...
        setValidationError(`Please enter your ${missingFields[0]} and ${missingFields[1]}`);
      } else {
    ...
    if (!zipPattern.test(zipCode.trim())) {
      setValidationError('Please enter a valid ZIP code (e.g., 90210 or 90210-1234)');
      return;
    }
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  animate={{ 
                    borderColor: ['rgba(0, 128, 128, 0)', 'rgba(0, 128, 128, 0.3)', 'rgba(0, 128, 128, 0)']
                  }}
                ...
                <div className="text-center mb-8 relative z-10">
                  ...
                  >
                    Our proprietary AI searches across <span className="text-teal-400 font-semibold">52+ databases</span> using your personal and address history
                  </motion.div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <InputField
                        ...
                        onKeyPress={(e) => e.key === 'Enter' && isFormValid && handleSearch()}
                  ...
                  >
                    {isFormValid ? (
                      ...
                      <span className="text-gray-400">
                        Fill in all required fields to begin comprehensive search
                      </span>
                    )}
                  </motion.div>
            ...
            >
                ...
                <div className="glass-card-teal rounded-lg p-6">
                  ...
                  <div className="mb-6">
                    <motion.div 
                      ...
                      transition={{ delay: 1 }}
                    >
                      <span>Searching: {firstName} {lastName} @ {city}, CA</span>
                    ...
                    {[
                      ...
                      >
                        <motion.div
                          ...
                          animate={searchProgress > (index * 15) ? {
                            scale: [1, 1.3, 1],
                            opacity: [1, 0.7, 1]
                          } : {}}
              ...
              >
                <div className="inline-flex items-center space-x-3 text-teal-400 mb-3">
                  ...
                  />
                  <span className="text-lg font-semibold">Enhanced AI search in progress...</span>
                </div>
                <motion.div 
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  Using address history to find all connected properties. This typically takes lawyers 6-18 months.
                </motion.div>
